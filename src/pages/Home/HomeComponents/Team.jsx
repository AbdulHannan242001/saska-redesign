  ...
  return (
    <main className="w-full relative bg-dark text-white pt-[60px]">
      <div className="flex flex-col gap-[55px] max-w-[1600px] mx-auto py-[30px]">
        ...
        <motion.div viewport={{ once: true }} initial={{ opacity: 0, y: 50 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, ease: "easeInOut" }} className="flex flex-col flex-wrap md:flex-row justify-center items-center gap-[30px] mx-auto z-50">
