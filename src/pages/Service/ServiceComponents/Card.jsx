...
const Card = ({ title, description, media }) => {
  ...
  return (
    <main className="lg:w-fit h-full min-w-[400px] min-h-[500px] rounded-2xl flex flex-col py-[10px] justify-start gap-[54px] relative z-50 bg-gradient-to-tl to-dark from-primary/10 text-white backdrop-blur-sm overflow-hidden">
