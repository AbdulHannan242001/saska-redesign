...
const Card = ({ title, description, media }) => {
  return (
    <main className=" md:w-[450px] h-full min-h-[500px] rounded-2xl shadow-gray-300 shadow-lg flex flex-col py-[10px] justify-start gap-[54px] relative z-50 bg-gradient-to-t to-white from-primary/10 text-dark backdrop-blur-sm overflow-hidden">
