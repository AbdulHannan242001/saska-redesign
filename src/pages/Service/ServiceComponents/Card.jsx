...
const Card = ({ title, description, media }) => {
  ...
  return (
    <main className="lg:w-fit h-full min-h-[500px] rounded-2xl flex flex-col py-[10px] justify-start gap-[54px] relative z-50 bg-gradient-to-tl to-dark from-primary/10 text-white backdrop-blur-sm overflow-hidden">
      <div className="h-full p-[10px] lg:p-[20px]">
        ...
        <div className="flex flex-col gap-[5px] mb-[30px]">
          ...
          <p className="md:min-h-[30vh] max-w-xs">{description}</p>
        </div>
