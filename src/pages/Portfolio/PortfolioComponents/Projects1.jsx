    ...
    <main className="w-full">
      <div ref={target} className="w-full h-[200vh]">
        <div className="flex flex-col lg:flex-row h-screen md:h-[calc(100vh-60px)] sticky top-15 md:top-15">
          <div className="w-full lg:w-5/12 p-[10px] md:p-[30px] bg-gradient-to-b from-dark to-zinc-950 flex flex-col justify-center relative overflow-hidden h-[50vh] md:h-full">
          ...
          <div className="w-full lg:w-7/12 relative flex flex-row justify-between items-center overflow-hidden h-[50vh] md:h-full">
