...
const RevealFooter = () => {
  return (
    <div
      className="relative h-screen md:h-[40vh] max-w-[1600px] mx-auto px-4 md:px-0"
      style={{ clipPath: "polygon(0% 0, 100% 0, 100% 100%, 0 100%)" }}
    >
      <div className="relative h-screen md:h-[calc(100vh+40vh)] -top-[0vh] md:-top-[100vh]">
        <div className="sticky top-0 md:top-[calc(100vh-40vh)] h-screen md:h-[40vh]">
          <div className="bg-white h-screen md:h-[40vh] text-gray-800 flex flex-col md:flex-row justify-around items-start pt-6 md:pt-10 pb-8 md:pb-0">
            {/* Logo & Socials */}
            ...
            <div className="flex flex-col gap-4 w-full md:w-auto mb-6 md:mb-0">
              <p className="font-semibold text-gray-500 uppercase text-sm md:text-base">
                Pages
              </p>
